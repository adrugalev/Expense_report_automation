      ...
      {report.status === "completed" ? (
        <div className="space-y-7">
          <section className="border-y border-green-200 bg-green-50 px-4 py-4 dark:border-green-900 dark:bg-green-950/25">
            ...
            <p className="mt-1 text-sm text-green-800 dark:text-green-300">{user?.role === "admin" ? "Файлы сохранены в истории и готовы к скачиванию." : "Файлы готовы к скачиванию."}</p>
          </section>
